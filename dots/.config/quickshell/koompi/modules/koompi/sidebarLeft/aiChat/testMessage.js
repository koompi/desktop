// The `/test` fixture: one message that exercises every construct AiMessage
// renders (think block, headings, table, code, LaTeX, inline HTML). Shown only
// when Config.options.ai.debugCommands is on. Kept out of ChatCommands.qml so
// the command table stays readable.
.pragma library

// iconSource: URL of the icon the <img> line embeds; iconHeight: its height in px.
function text(iconSource, iconHeight) {
    return `
<think>
...
- Arch lincox icon <img src="${iconSource}" height="${iconHeight}"/>
